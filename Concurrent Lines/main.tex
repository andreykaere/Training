...
\noindent {\normalfont\fontsize{15}{15}\textbf{Примечание}}
...
за рамки данного раздела. Отметим, что эту теорему можно доказать
с использованием теоремы Менелая или с помощью выхода в пространство.
С одним из них  вы можете ознакомиться самостоятельно,
например, в книге \textquote{Элементарная Геометрия Том 1}.
