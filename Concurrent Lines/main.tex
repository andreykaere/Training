...
\begin{note}
    ...
    m_i = 0\). Тогда система %\(\mathfrak{M}\)%сгруппируем все массы, за исключением
...
\big\{X(m_x), 
Y(m_y), Z(m_z)\big\}\) для некоторых масс \(m_x, m_y, m_z\), то мы
выполнили требуемое условие в силу \textbf{единственности} ц.м. \(M\).}}\\
